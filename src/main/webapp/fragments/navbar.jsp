    ...
    <section class="profile">
        ...
        <div class="profile-details">
            ...
            <div class="profile-info">
                ...
                <p>Account created at: <%=user.getCreatedAt().format(DateTimeFormatter.ISO_LOCAL_DATE)%></p>
...
//                for (Orders order : ordersList) {
            %>
            <div class="order">
<%--                <h4><%=order.getCart().isPaid() ? "Archive" : "Active"%></h4>--%>
                <img src=".././resources/img/838e7ce1-3edf-437b-97ca-cd32422b58da.png" alt="%>" class="order-img">
